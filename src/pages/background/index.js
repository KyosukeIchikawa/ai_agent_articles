  ...
  return (
    <Layout title="背景">
      <div className="space-y-8">
        <header>
          <h1 className="text-3xl font-bold mb-4 text-gray-800">1. 背景</h1>
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4 text-gray-800">1.1 オープンワールド環境の課題</h2>
          <div className="prose max-w-none">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 my-6">
              <h3 className="text-xl font-semibold mb-3 text-gray-800">環境の不確実性と動的変化</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 my-6">
              <h3 className="text-xl font-semibold mb-3 text-gray-800">新規性への適応</h3>
              <ul className="list-disc pl-6 space-y-2">
                <li>
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4 text-gray-800">1.2 従来のアプローチとその限界</h2>
          <div className="prose max-w-none">
            <p>
            ...
            <div className="grid md:grid-cols-2 gap-6 my-6">
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                <h3 className="text-xl font-semibold mb-3 text-blue-600">記号的計画アプローチ（TAMP）</h3>
                ...
                <h4 className="text-lg font-medium mt-4 mb-2 text-gray-800">限界：</h4>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                <h3 className="text-xl font-semibold mb-3 text-green-600">強化学習アプローチ</h3>
                <p className="text-gray-700">
            ...
            <h3 className="text-xl font-bold mb-3 text-gray-800">データ効率と適応性のジレンマ</h3>
            <p>
            ...
            <div className="bg-yellow-50 p-6 rounded-lg my-6">
              <h4 className="text-lg font-semibold mb-2 text-gray-800">既存アプローチの主な課題：</h4>
