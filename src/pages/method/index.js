          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-600 my-6">
              <figure className="text-center">
                ...
                <figcaption>図1: Curiosity-Driven Imaginationシステムのアーキテクチャ概要</figcaption>
              </figure>
            ...
            <p className="highlight">
              このハイブリッドアーキテクチャの主な特徴は、低レベルの学習ベースのアプローチと高レベルの記号的計画アプローチを
              <strong>想像空間</strong>を通じて統合している点です。これにより、従来の各アプローチの長所を活かしながら短所を補完しています。
            </p>
          </div>
        </section>
